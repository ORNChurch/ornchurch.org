	...
	<div class="footer-section">
		<div class="container">
			...
			<div class="footer-social-btn pull-right">
				...
				<?php if($heal_option['heal_github']) { ?>
				<a href="<?php echo esc_url($heal_option['heal_github']); ?>" class="github-btn"><i class="fa fa-github-alt"></i></a>
				<?php } ?>

				<?php if($heal_option['heal_vimeo']) { ?>
				<a href="<?php echo esc_url($heal_option['heal_vimeo']); ?>" class="vimeo-btn"><i class="fa fa-vimeo-square"></i></a>
				<?php } ?>

				<?php if($heal_option['heal_pinterest']) { ?>
				<a href="<?php echo esc_url($heal_option['heal_pinterest']); ?>" class="pinterest-btn"><i class="fa fa-pinterest"></i></a>
				<?php } ?>
				...
				<?php if($heal_option['heal_dribbble']) { ?>
				<a href="<?php echo esc_url($heal_option['heal_dribbble']); ?>" class="dribbble-btn"><i class="fa fa-dribbble"></i></a>
				<?php } ?>
				...
				<?php if($heal_option['heal_instagram']) { ?>
				<a href="<?php echo esc_url($heal_option['heal_instagram']); ?>" class="instagram-btn"><i class="fa fa-instagram"></i></a>
				<?php } ?>
