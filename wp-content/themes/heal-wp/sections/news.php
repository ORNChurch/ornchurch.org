		...
		<div class="news-section white-bg angular section-padding">
			...
			<div class="container">
				<?php } ?>
					...
					<div class="section-head clearfix clearfix">
					...
					<div class="view-all">
						<a href="<?php echo heal_get_blog_link(); ?>" class="btn custom-btn angle-effect"><?php echo ($heal_option['heal_news_button_text']) ? $heal_option['heal_news_button_text'] : _e('View All News', 'heal') ?></a>
					</div>
				</div><!-- /.news-container -->
			</div><!-- /.row -->
		</div><!-- /.container -->
