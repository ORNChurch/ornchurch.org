...
<div id="leave-comment" class="clearfix">
	...
	$comments_args = array(
		'fields' =>  $fields,
		'id_form'          			=> 'commentform',
		'title_reply'       		=> __( 'Leave a Comment', 'heal' ),
		'title_reply_to'    		=> __( 'Leave a Comment to %s', 'heal' ),
		'cancel_reply_link' 		=> __( 'Cancel Comment', 'heal' ),
		'label_submit'      		=> __( 'Post Comment', 'heal' ),
